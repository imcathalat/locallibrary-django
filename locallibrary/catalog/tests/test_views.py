...
class LoanedBooksByUserListViewTest(TestCase):
    def setUp(self):
        test_user1 = User.objects.create_user(username='testuser1', password='hiane3005')
        test_user2 = User.objects.create_user(username='testuser2', password='hiane3005')
    ...
    def test_pages_ordered_by_due_date(self):
        ...
        self.assertEqual(len(response.context['bookinstance_list']), 10) #onde esta esse bookinstance_list?
